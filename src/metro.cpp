...
public:
	wxMetroPopupMenuWindow( wxWindow *parent, long theme = 0)
		...
		m_theme( theme )
	{
		// added 1/10/2019: in 2018 wxwidgets 3.1.2
		// the wxpopupwindow was changed to block events by default
		// but in this case, we need to allow events to propagate to the
		// parent otherwise popup menu events are never handled
		// ref: https://github.com/wxWidgets/wxWidgets/commit/9562ca2b70c5421a9f3e94d6ea818efad0ac265b#diff-ae8d87556bfe1b32c101c69c2fb1cec4

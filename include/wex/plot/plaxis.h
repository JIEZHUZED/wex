...
public:
	...
	virtual void SetNumberFormat( int decimals = -1, bool thousep=false, 
		const wxString &pre=wxEmptyString, const wxString &post=wxEmptyString );
...
protected:
	...
	int m_decimals;
	bool m_thouSep;
	wxString m_preText, m_postText;

	wxString Format( double value );
};

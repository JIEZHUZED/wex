...
public:
	...
	void SetFontFamily( const wxString &family ) { m_textFont = family; }
	void SetFontSize( double points ) { m_textSize = points; }
	double GetFontSize() { return m_textSize; }
	...
	*/
	static bool SetDefaultFontFamily( const wxString &family );
